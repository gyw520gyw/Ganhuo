...
public class RoundedImageView extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        mBorderThickness = a.getDimensionPixelSize(R.styleable.Roundedimageview_roundedBorderThickness, 0);
        mBorderColor = a.getColor(R.styleable.Roundedimageview_roundedBorderColor, mBorderColor);
    }
    ...
    public static Bitmap getCroppedBitmap(Bitmap bmp, int radius) {
        ...
        paint.setColor(Color.parseColor("#BAB399"));//#BAB399
